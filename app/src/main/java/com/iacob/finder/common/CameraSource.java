...
public class CameraSource {
     ...
     */
    public List<SizePair> generateValidPreviewSizeList(Camera camera) {
        ...
        for (Camera.Size previewSize : supportedPreviewSizes) {
            ...
            //Log.i(TAG, "imagePreview " + previewSize.height + "x" + previewSize.width + " | " + previewAspectRatio);
            // By looping through the picture sizes in order, we favor the higher resolutions.
            // We choose the highest resolution in order to support taking the full resolution
            // picture later.
            for (Camera.Size pictureSize : supportedPictureSizes) {
                float pictureAspectRatio = (float) pictureSize.width / (float) pictureSize.height;
                //Log.i(TAG, "imageDimension " + pictureSize.height + "x" + pictureSize.width + " | " + pictureAspectRatio);
    ...
    private Camera createCamera() throws IOException {
        ...
        SizePair sizePair = selectSizePair(camera, getDisplayHeight() / 2, getDisplayWidth() / 2);
